...
public class ProjectInfos 
{
	...
	public static final String SRC_PATH = GlobalConfig.getSlash()+"src"+GlobalConfig.getSlash()+"com"
	...
	public static final String PRO_SRC_DIR = "/"+getProjectName()+"/"+"src"+PACKAGE_PATH;
